...
potencia_termo = 100
custo_capital_termo = 100
custo_oem = 100
taxa_de_juros = 100
tempo_pagar_divida = 100
eficiencia_aeroGT = 100
eficiencia_steam = 100
eficiencia_NG = 100
energia_combustivel = 100
preco_combustivel = 100
custo_ciclo_aeroGT_cold = 100
custo_ciclo_steam_cold = 100
custo_ciclo_NG_cold = 100
custo_ciclo_aeroGT_warm = 100
custo_ciclo_steam_warm = 100
custo_ciclo_NG_warm = 100
custo_ciclo_aeroGT_hot = 100
custo_ciclo_steam_hot = 100
custo_ciclo_NG_hot = 100
limite_ciclo_aeroGT_cold = 100
limite_ciclo_steam_cold = 100
limite_ciclo_NG_cold = 100
limite_ciclo_aeroGT_warm = 100
limite_ciclo_steam_warm = 100
limite_ciclo_NG_warm = 100
limite_ciclo_aeroGT_hot = 100
limite_ciclo_steam_hot = 100
limite_ciclo_NG_hot = 100


custo_oem, taxa_de_juros, \
    tempo_pagar_divida, eficiencia_aeroGT, eficiencia_steam, eficiencia_NG, \
    energia_combustivel, preco_combustivel, custo_ciclo_aeroGT_cold, \
    custo_ciclo_steam_cold, custo_ciclo_NG_cold, custo_ciclo_aeroGT_warm, \
    custo_ciclo_steam_warm, custo_ciclo_NG_warm, custo_ciclo_aeroGT_hot, \
    custo_ciclo_steam_hot, custo_ciclo_NG_hot, limite_ciclo_aeroGT_cold, \
    limite_ciclo_steam_cold, limite_ciclo_NG_cold, limite_ciclo_aeroGT_warm, \
    limite_ciclo_steam_warm, limite_ciclo_NG_warm, limite_ciclo_aeroGT_hot, \
    limite_ciclo_steam_hot, limite_ciclo_NG_hot
