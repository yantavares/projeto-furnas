...
class FormularioFurnas:
    ...
    def inicializar_widgets(self):
        ...
        self.botao_enviar = Button(
            description='Enviar', layout=Layout(width='200px', height='50px', margin='20px 10px 10px 530px'), style=ButtonStyle(button_color='#72783d'))
        self.botao_exportar_csv = Button(
            description='Exportar CSV', layout=Layout(margin='10px 10px 10px 400px'))
